    ...
    <div class="partner-section">
      ...
      <template v-if="activeTab === 'partners'">
        ...
        >
          ...
          <span class="status" :class="partner.statusClass">
            {{ partner.status }}
          </span>
      ...
      <template v-if="activeTab === 'leads'">
        ...
        <div class="partner-row" v-for="lead in filteredLeads" :key="lead.id">
          <div class="partner-info">
            <strong>{{ lead.email }}</strong>
          </div>

          <span class="status" :class="lead.statusClass">
            {{ lead.status }}
          </span>
      ...
      <div class="survey-modal">
        ...
        <div class="survey-answer-list">
          ...
          <div class="survey-answer-card">
            ...
            <p>
              Vi vil gerne starte med konfiguration, bestilling og brand
              guidelines.
            </p>
          </div>
        </div>
...
function getAssignments() {
  ...
  localStorage.setItem(ASSIGNMENTS_KEY, JSON.stringify(dummyCourseAssignments));
